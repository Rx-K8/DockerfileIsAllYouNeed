...
Update: 2024/01/18: FUKUOKA Keito
-----------------------------------------------------------
EOF_COMMENT

# nvidia/cuda docker images versions
declare -A CUDA_VERSIONS=(
  ['cuda12.1']='nvidia/cuda:12.1.1-cudnn8-devel-ubuntu22.04'
  ['cuda11.8']='nvidia/cuda:11.8.0-cudnn8-devel-ubuntu22.04'
  ['cuda11.7']='nvidia/cuda:11.7.1-cudnn8-devel-ubuntu22.04'
  ['cuda11.6']='nvidia/cuda:11.6.1-cudnn8-devel-ubuntu20.04'
  ['cuda11.5']='nvidia/cuda:11.5.2-cudnn8-devel-ubuntu20.04'
  ['cuda11.4']='nvidia/cuda:11.4.3-cudnn8-devel-ubuntu20.04'
  ['cuda11.3']='nvidia/cuda:11.3.1-cudnn8-devel-ubuntu20.04'
  ['cuda11.2']='nvidia/cuda:11.2.2-cudnn8-devel-ubuntu20.04'
  ['cuda11.1']='nvidia/cuda:11.1.1-cudnn8-devel-ubuntu20.04'
  ['cuda11.0']='nvidia/cuda:11.0.3-cudnn8-devel-ubuntu20.04'
)
